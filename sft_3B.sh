#!/bin/bash
# Modified for 2×RTX 6000 (96GB) with Qwen2-3B
...
for category in "Industrial_and_Scientific"; do
    ...
    # Modified: 2 GPUs with RTX 6000 96GB
    torchrun --nproc_per_node 2 \
            ...
            --eval_file ${eval_file} \
            --output_dir output_dir/qwen2_3B_sft \
            --wandb_project minionerec_3B \
            --wandb_run_name sft_3B_2xrtx6000 \
            --category ${category} \
